...
extern int lobby_choice;

extern int where_am_i;

extern int did_look_around_1;
extern int am_i_free_1;
extern int looking_window_unfree_1;
extern int looking_table_unfree_1;
